...
<div class="text-center"><img class="text-center" style="padding-bottom:0px; padding-left:0%; width:200px; height:30%;" src="http://beam.la/DragonflyLogo.png"></div>
...
<form action="/search/" method="GET">
	<div class="input-group" style="width:80%; padding-left:20%;">
		...
		<input  id="searchBox" autocomplete="off" spellcheck="false"  type="submit" value="Fly" style=" background-color:rgba(255, 255, 255, .6)" class="btn btn-default" type="button">
		</span>
	</div>
</form>
