...
<div><div class="btn-group btn-group-sm" role="group" aria-label="...">
 ...
 <button type="button" class="btn btn-group-sm btn-default"   onclick="responsiveVoice.speak($('#text').val(),$('#voiceselection').val());"> <img src="http://dragonflysearch.com/images/glyphicons-185-volume-up.png" style="width:18px; height:18px;"></button>
