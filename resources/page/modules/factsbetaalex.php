...
<div><div class="btn-group btn-group-sm" role="group" aria-label="...">
 ...
 <button type="button" class="btn btn-group-sm btn-default"  > <img src="http://dragonflysearch.com/images/glyphicons-185-volume-up.png" style="width:18px; height:18px;"></button>
<button type="button" class="btn btn-group-sm btn-default"   onclick="responsiveVoice.speak('<?php echo $fact; ?>');"> <img src="http://beam.la/glyphicons-151-edit.png" style="width:18px; height:18px;"></button>
