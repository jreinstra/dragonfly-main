<blockquote>
 ...
 <a href="http://www.britannica.com/search?query=<?php echo $subject; ?>"  target="_blank"><small>Encyclopedia Britannica<cite title="Source Title"></cite></small></a>
  ...
  <div class="modal-dialog" style="width:80%; height:93%;">
    <div class="modal-content" style="height:95%;">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-left" id="myModalLabel">More info from - britannica.com/<?php echo $subject; ?></h4>
      </div>
